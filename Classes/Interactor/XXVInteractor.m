        ...
        if (block) {
            switch ( [c[@"kind"] integerValue]) {
                case NSKeyValueChangeSetting:
                    NSLog(@"赋值");
                    if (block) {
                        block(self.presenter,value,NULL,NULL,NULL);
                    }
                    break;
                case NSKeyValueChangeInsertion:
                    NSLog(@"插入");
                    if (block) {
                        block(self.presenter,value,c,NULL,NULL);
                    }
                    break;
                case NSKeyValueChangeRemoval:
                    NSLog(@"删除");
                    if (block) {
                        block(self.presenter,value,NULL,c,NULL);
                    }
                    break;
                case NSKeyValueChangeReplacement:
                    NSLog(@"替换");
                    if (block) {
                        block(self.presenter,value,NULL,NULL,c);
                    }
                    break;
                default:
                    break;
...
- (Class)routerClass
{
    return NSClassFromString(@"XXVRouter");
}
