...
@interface XXVCollectViewOutput () <UICollectionViewDataSource, UICollectionViewDelegate>
//@property (nonatomic, strong) UICollectionView* collectionView;
@end

@implementation XXVCollectViewOutput

//- (XXVCollectionViewDelegate *)delegate
//{
//    if (!_delegate) {
//        _delegate = [[XXVCollectionViewDelegate alloc] init];
//    }
//    return _delegate;
//}
...
//    self.delegate.interactor = self.interactor;
